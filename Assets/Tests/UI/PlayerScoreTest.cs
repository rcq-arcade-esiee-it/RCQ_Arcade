...
public class GPlayerScoreITest : InputTestFixture
{
    ...
    public IEnumerator _01_ScoreNameShoudBeInitailiseToAAAOnePlayer()
    {
        ...
        Assert.IsTrue(GameObject.Find("MainCanvas/ScoreCanvas/OnePlayerGameCanvas/Player1").GetComponentsInChildren<TextMeshProUGUI>()[1].text == "A"); 
        Assert.IsTrue(GameObject.Find("MainCanvas/ScoreCanvas/OnePlayerGameCanvas/Player1").GetComponentsInChildren<TextMeshProUGUI>()[2].text == "A"); 
        Assert.IsTrue(GameObject.Find("MainCanvas/ScoreCanvas/OnePlayerGameCanvas/Player1").GetComponentsInChildren<TextMeshProUGUI>()[3].text == "A"); ;
    ...
    public IEnumerator _02_ScoreNameShoudBeInitailiseToAAAAndTwoPlayer()
    {
        ...
        Assert.IsTrue(GameObject.Find("MainCanvas/ScoreCanvas/TwoPlayerGameCanvas/Player1").GetComponentsInChildren<TextMeshProUGUI>()[1].text == "A"); 
        Assert.IsTrue(GameObject.Find("MainCanvas/ScoreCanvas/TwoPlayerGameCanvas/Player1").GetComponentsInChildren<TextMeshProUGUI>()[2].text == "A"); 
        Assert.IsTrue(GameObject.Find("MainCanvas/ScoreCanvas/TwoPlayerGameCanvas/Player1").GetComponentsInChildren<TextMeshProUGUI>()[3].text == "A"); ;
    ...
    public IEnumerator _03_ScoreNameChangeFirstLetterIfKeyDownOrUpPressed()
    {
        ...
        Assert.IsTrue(GameObject.Find("MainCanvas/ScoreCanvas/TwoPlayerGameCanvas/Player2").GetComponentsInChildren<TextMeshProUGUI>()[1].text == "Z");

        yield return new WaitForSeconds(2f);
        Press(keyboard.downArrowKey);
        yield return new WaitForSeconds(2f);
        Assert.IsTrue(GameObject.Find("MainCanvas/ScoreCanvas/TwoPlayerGameCanvas/Player2").GetComponentsInChildren<TextMeshProUGUI>()[1].text == "A");
        
        
        
        Assert.IsTrue(GameObject.Find("MainCanvas/ScoreCanvas/TwoPlayerGameCanvas/Player2").GetComponentsInChildren<TextMeshProUGUI>()[2].text == "A"); 
        Assert.IsTrue(GameObject.Find("MainCanvas/ScoreCanvas/TwoPlayerGameCanvas/Player2").GetComponentsInChildren<TextMeshProUGUI>()[3].text == "A"); ;
    ...
    public IEnumerator _04_ScoreNameChangeLetterCaseIfLeftOrRightPressed()
    {
        ...
        Assert.IsTrue(GameObject.Find("MainCanvas/ScoreCanvas/TwoPlayerGameCanvas/Player2/ThirdLetterPlayer").GetComponentsInChildren<SpriteRenderer>()[0].sortingOrder == 1);
        Assert.IsTrue(GameObject.Find("MainCanvas/ScoreCanvas/TwoPlayerGameCanvas/Player2/FirstLetterPlayer").GetComponentsInChildren<SpriteRenderer>()[0].sortingOrder == 0);
